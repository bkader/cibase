...
$config['theme.site.name']        = 'CodeIgniter';
$config['theme.site.description'] = 'An amazing PHP Framework.';
$config['theme.site.keywords']    = 'these, are, dummy, keywords, use, yours, bkader, bouyakoub';
